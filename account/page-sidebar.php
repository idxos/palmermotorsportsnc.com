<div class="inner-box">
    <div class="user-panel-sidebar">
        <div class="collapse-box">
            ...
            <div id="MyClassified" class="panel-collapse collapse in" style="height: auto;">
                <ul class="acc-list">
        ...
        <h5 class="list-title"><strong><a href="#">Location</a></strong></h5>
            ...
            <div id="MyAds" class="panel-collapse collapse in">
                <ul class="acc-list">
                    <li class="active"><a href="account-myads.html"><i class="icon-docs"></i> My ads <span class="badge">42</span> </a></li>
        ...
        <div class="collapse-box">
            <h5 class="collapse-title"> Terminate Account <a class="pull-right collapsed" data-toggle="collapse" href="#TerminateAccount"><i class="fa fa-angle-down"></i></a></h5>
            <div id="TerminateAccount" class="panel-collapse collapse" style="height: 0px;">
                <ul class="acc-list">
