/*! CloudFlareJS-0.1.16 Tue Mar 31 2015 23:27:10
 */
! function(a, b) {
    var c = {};
    ! function(a, b) {
    ...
    ! function(a, b) {
        ...
        return o.prototype.append = function(a, b) {
            ...
            return new c(b.bind(function(a, c) {
                function d() {
                    return "responseURL" in f ? f.responseURL : /^X-Request-URL:/m.test(f.getAllResponseHeaders()) ? f.getResponseHeader("X-Request-URL") : void 0
                }
                var f = e();
    ...
    var Q = function(a) {
        ...
        qa = function(a, b, c) {
            a && (8 > ga && "style" === b ? a.style.cssText = c : "setAttribute" in a ? a.setAttribute(b, c) : a.attributes[b] = c)
        },
        ra = function(a, b) {
            a && (8 > ga && "style" === b ? a.style.cssText = "" : "removeAttribute" in a ? a.removeAttribute(b) : delete a.attributes[b])
        },
        sa = function(a, b) {
            return a ? "dataset" in a ? a.dataset[b] : pa(a, "data-" + b) : void 0
        },
        ta = function(a, b, c) {
            a && ("dataset" in a ? a.dataset[b] = c : qa(a, "data-" + b, c))
        },
        ua = function(a, b) {
            a && ("dataset" in a ? delete a.dataset[b] : ra(a, "data-" + b))
        },
        va = function(a, b, c, d) {
            ka() ? a.addEventListener(b, c, d) : a.attachEvent("on" + b, c)
        },
        wa = function(a, b, c, d) {
            ka() ? a.removeEventListener(b, c, d) : a.detachEvent("on" + b, c)
        },
        xa = function() {
    ...
    var Sa = function(b) {
        ...
        Ua = function(b, d) {
            return b = Sa(c.resolveFullURL(b)), d = Sa(c.resolveFullURL(d ? d : a.location.href)), b.protocol === d.protocol && b.host === d.host && b.port === d.port
        },
        Va = function(a) {
            var b = Sa(a),
                c = b.path.split("/"),
            ...
            return function(b) {
                ...
                return l.onreadystatechange = function() {
                    try {
                        ...
                        a && a > 399 ? (l.onreadystatechange = Ra, k(a)) : 4 === b && m()
                    } catch (c) {
                        k("Uncaught exception while attempting to contact the cloud: " + c.message), l.onreadystatechange = Ra
                    }
    ...
    ! function() {
        var g = {},
            ...
            k = function(a) {
                var b, e = a.split("/");
                return c.resolveFullURL((b = d.paths[e[0]]) && "string" == typeof b ? b + ("/" !== b.substr(b.length - 1) ? "/" : "") + a + ".js" + (d.bustCache ? "?" + Ma() : "") : a)
            },
            l = function() {
                var a;
                return function() {
            ...
            x = function(a) {
                var c = "string" == typeof a && a,
                    d = function() {
                        c ? (delete g["__" + c + "_load"], delete g["__" + c + "_readystatechange"], delete g["__" + c + "_error"]) : (wa(a, "load", e), wa(a, "readystatechange", e), wa(a, "error", h))
                    },
                    e = function() {
                        c && (a = b.getElementById(c)), "readyState" in a && "loaded" !== a.readyState && "complete" !== a.readyState || (ga || s(sa(a, "module")), d(), i.resolve())
                    },
                    h = function() {
                ...
                }, 1e4), c ? (g["__" + c + "_load"] = e, g["__" + c + "_readystatechange"] = e, g["__" + c + "_error"] = h) : (va(a, "load", e), va(a, "readystatechange", e), va(a, "error", h)), i.promise
            },
            z = function() {
                var a = [],
                    c = {},
            ...
            D = function() {
                var a = arguments.length,
                    ...
                    f = V();
                return w(b) ? f.reject(new Error('Module "' + name + '" is already defined.')) : e ? (ga && !b && (b = sa(l(), "module")), b ? i[b] = f : q(f), F(c, function() {
                    var a = {},
                        g = {},
                        h = {},
                        i = arguments;
        ...
        }), i.exports = V(), i.exports.resolve(), i.module = V(), i.module.resolve(), g.require = F, g.require.paths = d.paths, g.define = D, g.define.amd = {}, g.block = E, g.push = G, g.version = e + "", va(a, "load", function() {
            g.block = g.require
    ...
    if (bb("cloudflare/deferred", function() {
            ...
            var a = {};
            return a.log = "undefined" != typeof I ? I : Ra, a.error = "undefined" != typeof J ? J : Ra, a.info = "undefined" != typeof K ? K : Ra, a.trace = "undeinfed" != typeof L ? L : Ra, a.LOG = z, a.INFO = A, a.ERROR = B, a.ASSERT = C, a.TRACE = D, a.EXECUTION = E, a.PARSER = F, a.HACK = G, a.WARNING = H, a
            ...
            var a = {};
            return a.parseURL = Sa, a.stringifyURL = Ta, a.parseExtension = Va, a.resolveFullURL = c.resolveFullURL, a.resolvePath = Wa, a.sameOrigin = Ua, a
        ...
        var db = {};
        db.cdnjs = 0, db.smrtln = 0, db.excpnhb = 0, db.ape = 0, db.panopta = 0, db.blitz = 0, db.cdgrd = 0, db.dome9 = 0, db.gsha = 0, db.monitis_key = 0, db.ping_key = 0, db.stphck = 0, db.webmst = 0, db.zoompf_report = 0, db.mobeeself = 0, db.verelo = 0, p(d.apps, function(a, b) {
            0 !== db[b] && ("highlight" === b ? b = "cloudflare/highlight" : d.paths[b] = a && a.cfjs_path || d.paths.cloudflare + "apps/", bb(b + "/config", function() {
                return a
            }), "ga_key" != b && cb([b]))
        })
    }
