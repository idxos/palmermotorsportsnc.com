...
<html lang="en">
 <head>
<meta charset="utf-8">
  <title>Palmer Motorsports - Details</title>
...
<div id="wrapper">
    ...
    <div class="main-container">  
        ...
        <div class="container">
            <?php include('details/page-breadcrumb-nav.php'); ?>
        </div><!--/.container-->
        ...
        <div class="container">
            <div class="row">
                ...
                <section class="col-sm-9 page-content col-thin-right">
                    <?php include('details/page-content.php'); ?>
                </section><!--/.col-->

                <section class="col-sm-3 page-sidebar-right">
                    <aside>
                        <?php include('details/page-sidebar.php'); ?>
                    </aside>
                </section><!--/.col-->
