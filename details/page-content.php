<div class="inner inner-box ads-details-wrapper">
    ...
    <div class="ads-image">
        ...
        <div class="bx-wrapper" style="max-width: 100%;">
            <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 379px;">
                <ul class="bxslider" style="width: 515%; position: relative; -webkit-transition-duration: 0s; transition-duration: 0s; -webkit-transform: translate3d(-673px, 0px, 0px);">
                    <li style="float: left; list-style: none; position: relative; width: 673px;" class="bx-clone"><img src="http://www.wpsstatic.com/WPSIMAGES/Large/352-0360.jpg" alt="img"></li>
                    <li style="float: left; list-style: none; position: relative; width: 673px;"><img src="http://www.wpsstatic.com/WPSIMAGES/Large/352-0360.jpg" alt="img"></li>
                    <li style="float: left; list-style: none; position: relative; width: 673px;"><img src="http://www.wpsstatic.com/WPSIMAGES/Large/352-0360.jpg" alt="img"></li>
                    <li style="float: left; list-style: none; position: relative; width: 673px;"><img src="http://www.wpsstatic.com/WPSIMAGES/Large/352-0360.jpg" alt="img"></li>
                </ul>
            </div>
        ...
        <div id="bx-pager">
            <a class="thumb-item-link active" data-slide-index="0" href=""><img src="http://www.wpsstatic.com/WPSIMAGES/thumbs/352-0360.jpg" alt="img"></a>
            <a class="thumb-item-link" data-slide-index="1" href=""><img src="http://www.wpsstatic.com/WPSIMAGES/thumbs/352-0360.jpg" alt="img"></a>
            <a class="thumb-item-link" data-slide-index="2" href=""><img src="http://www.wpsstatic.com/WPSIMAGES/thumbs/352-0360.jpg" alt="img"></a>
        </div>
    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="ads-action">
                    <ul class="list-border">
                        <li>
                            <a href="#"> <i class="ion-ios-person size-20"></i> More ads by User </a>
                        </li>
                        <li>
