                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="category-group" id="category-group" class="form-control">
                              ...
                              <option value="Motorcycle Equipment"> Motorcycle Equipment </option>
                              <option value="dirt_bikes"> Parts </option>
                              <option value="atv"> Atvs </option>
                              <option value="atv"> Utvs </option>
                              <option value="Boats"> Boats </option>
                              <option value="Boats"> Personal Watercraft </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <label class="radio-inline" for="radios-0">
                                <input name="radios" id="radios-0" value="Private" checked="checked" type="radio"> Private </label>
                            <label class="radio-inline" for="radios-1">
                                <input name="radios" id="radios-1" value="Business" type="radio"> Business </label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox"> Negotiable </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="input-group ">
   ...
   <div class="file-caption-name" style="width: 242.06px;"></div>
</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <label class="checkbox-inline" for="checkboxes-0">
                                <input name="checkboxes" id="checkboxes-0" value="Remember above contact information." type="checkbox"> Remember above contact information. </label>
                        </div>
                    </div>
                    <div class="form-group">
